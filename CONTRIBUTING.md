...
* In Github, fork `https://github.com/jasmineavixo/gowsdl` to your own account
* Get the package using "go get": `go get github.com/jasmineavixo/gowsdl`
* Move to where the package was cloned: `cd $GOPATH/src/github.com/jasmineavixo/gowsdl/`
